...
- **340 tests passing** (12.5s)
- **47 Python source files, ~7800 LOC**
- **2 SQLite migrations**
...
├── cli.py               (906) All subcommands (db, collect, status, inspect, triage, verify, dataset, discover, import-coco, benchmark, train, gate, deploy, run, web)
...
├── collection/
│   ├── collector.py     (496) Collector: reviews→events→snapshots→Samples, ThreadPoolExecutor, dedup, region crop
